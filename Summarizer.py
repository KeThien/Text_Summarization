...
# from spacy import fr_core_news_md


class Summarizer:
    def __init__(self, model, stop_words=None, device=None, log=False):
    ...
    #def init_model(self):
        ...
        # Flaubert model
            ...
            # Camembert model
                ...
                camembert = AutoModel.from_pretrained("camembert/camembert-large")
    ...
    def word_embedding(self, word):
        ...
        # Flaubert
            ...
            token_embedding = torch.stack(last_layers.to_tuple(), dim=0)[0]
    ...
    def camembert_embedding(self, sentence):
        ...
        token_embeddings = torch.stack(encoded_layers.to_tuple(), dim=0)
